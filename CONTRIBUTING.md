...
Development conventions for `@interop/http-client`. See [AGENTS.md](./AGENTS.md) for toolchain and project layout; agents receive this file automatically via the `@CONTRIBUTING.md` include there.
